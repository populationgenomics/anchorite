...
def test_identical_range_spans_are_properly_nested() -> None:
    ...
    content = "Hello"
    bbox_a = anchorite.Anchor(text="Hello", page=1, box=anchorite.BBox(0, 0, 5, 1))
    bbox_b = anchorite.Anchor(text="Hello", page=1, box=anchorite.BBox(0, 0, 5, 2))
...
def test_co_terminal_closing_spans() -> None:
    ...
    content = "abcde"
    bbox_outer = anchorite.Anchor(text="", page=1, box=anchorite.BBox(0, 0, 1, 1))
    bbox_inner = anchorite.Anchor(text="", page=1, box=anchorite.BBox(0, 0, 2, 2))
...
def test_zero_length_span_at_abutting_boundary() -> None:
    ...
    bbox_zero = anchorite.Anchor(text="", page=0, box=anchorite.BBox(10, 0, 10, 100))
